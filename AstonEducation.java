public class AstonEducation {
    ...
    /**
     * Метод суммирует две переменные и выводит сообщение о сумме.
     */
    ...
    public static void printColor() {
        System.out.println("\nЗадание 3:");
        int value = 101; //можно задать любое значение
